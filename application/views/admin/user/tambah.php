                                ...
                                <div class="col-md-6 col-x-12">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="customRadio1" name="jenis_kelamin" value="l" checked>
                                            <label for="customRadio1" class="custom-control-label">Laki-Laki</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="customRadio2" name="jenis_kelamin" value="p">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-x-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="gaji" value="0" min="0" required class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
