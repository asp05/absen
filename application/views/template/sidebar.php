...
<aside class="main-sidebar elevation-4 sidebar-light-primary">
    ...
    <a href="<?= base_url(); ?>" class="brand-link">
        <img src="<?= base_url(); ?>assets/admin/dist/img/smk.jpeg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">SIAG</span>
    </a>
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('homeadmin') ?>" class="nav-link">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('admin/historiabsen') ?>" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Absensi</p>
                            </a>
                        </li>
